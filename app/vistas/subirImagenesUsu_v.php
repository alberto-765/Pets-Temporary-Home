<main id="wrapperRegistro" class="flex-grow-1 d-flex flex-column">
            ...
            <form class="row rounded p-4 row-gap-4 text-center needs-validation" action="#" id="formSubir" novalidate>
                ...
                if (isset($_SESSION["tipoUser"]) && $_SESSION["tipoUser"] == "cuidador") { ?>
                    ...
                    <div class="mb-md-3 text-start">
                        ...
                        <div class="form-text">Puedes subir hasta 10 fotografías para tu galería</div>
    ...
    <script src="<?= BASE_URL; ?>app/vistas/js/subirImagenesUsu.js"></script>