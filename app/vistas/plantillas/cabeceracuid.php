...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE_URL; ?>app/vistas/css/cuidadores.css" />
...
<body class="d-flex flex-column ">
    ...
    <header class=" sticky-top shadow py-2 " id="header" data-tipo="cuidador">
          ...
          container justify-content-around justify-content-sm-between">
            ...
            <div class="collapse navbar-collapse justify-content-end align-items-center mt-2 mx-4 mx-sm-0" id="menu">
                <ul class="navbar-nav gap-3">
                    ...
                    <li class="nav-item" mouseOver>
                        <a class="btn btn-outline-dark shadow" href="<?= BASE_URL ?>Cuidadores_c/reservas" style="background-color: transparent !important;">
                    ...
                    <li class="nav-item mouseOver">
                        ...
                        <button class="btn border-dark" type="button" data-bs-toggle="offcanvas" data-bs-target="#perfilCanvas" aria-controls="perfilCanvas">
                            <img src="<?= BASE_URL ?>app/assets/iconos/user.svg" alt="Icono Usuario" style="height: 25px;"></button>
